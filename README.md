...
Scenario 1: [e.g., User Login and Dashboard Navigation]

Scenario 2: [e.g., Applying for Leave (as seen in your error message context)]

Scenario 3: [e.g., Data validation on form submission]
